...
def UPDATE_COURSE(request):
    ...
    return render(request, 'Hod/edit.html',context)
...
def ADD_SUBJECT(request):
    ...
    if request.method=="POST":
        ...
        messages.success(request, 'Subject Are Succesfully Added')
...
def STUDENT_SENT_NOTIFICATION(request):
    student=Student.objects.all()
...
def SAVE_STUDENT_NOTIFICATION(request):
    ...
    return redirect('student_sent_notification')
