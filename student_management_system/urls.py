...
urlpatterns = [
    ...
    path('hod/staff/leave/approve_leave/<str:id>', Hod_Views.STAFF_APPROVE_LEAVE, name='staff_approve_leave'),
    path('hod/staff/leave/disapprove_leave/<str:id>', Hod_Views.STAFF_DISAPPROVE_LEAVE, name='staff_disapprove_leave'),
    ...
    path('hod/student/sent_notification', Hod_Views.STUDENT_SENT_NOTIFICATION, name='student_sent_notification'),
    path('hod/student/save_notification', Hod_Views.SAVE_STUDENT_NOTIFICATION, name='student_save_notification'),
    path('hod/student/feedback', Hod_Views.STUDENT_FEEDBACK, name='get_student_feedback'),
    path('hod/student/feedback/reply_save', Hod_Views.REPLY_STUDENT_FEEDBACK, name='reply_student_feedback'),
    path('hod/student/leave_view', Hod_Views.STUDENT_LEAVE_VIEW, name='student_leave_view'),
    path('hod/student/leave/approve_leave/<str:id>', Hod_Views.STUDENT_APPROVE_LEAVE, name='student_approve_leave'),
    path('hod/student/leave/disapprove_leave/<str:id>', Hod_Views.STUDENT_DISAPPROVE_LEAVE, name='student_disapprove_leave'),
    ...
    path('staff/take_attendance',Staff_Views.TAKE_ATTENDANCE, name='staff_take_attendance'),
    ...
    path('student/notifications', Student_Views.STUDENT_NOTIFICATION, name='notifications'),
